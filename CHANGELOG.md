...
- 834ff13: Export complete infra API from main package entry point
...
- 4388dc0: Add Zod schemas for infrastructure manifest validation
...
- 7f54559: Remove prettier references from project documentation and configuration

## 2.1.0

### Minor Changes

- 5a24fc6: Add `cm infra scan` command for AWS resource existence verification
...
- bcefe40: feat(mcp): add MCP server for dynamic standards composition
...
- 17943c5: feat(gitleaks): add scan mode options for secrets detection
