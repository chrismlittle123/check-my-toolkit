...
2. Single command to verify configs exist: `cm audit`
3. Domain-specific commands: `cm code check`, `cm process check`, `cm stack check`
4. Configuration via `check.toml`
5. Clear, actionable output with exit codes for CI integration
