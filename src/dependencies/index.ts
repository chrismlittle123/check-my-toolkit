/**
 * Core implementation of the cm dependencies command
 */
...
import { type Config, getProjectRoot, loadConfigAsync } from "../config/index.js";
...
/**
 * Get tool configuration from check.toml config by tool ID
 */
...
export async function getDependencies(
  ...
  return {
    ...
    checkTomlPath: path.relative(projectRoot, configPath) || "check.toml",
    dependencies,
    alwaysTracked,
    allFiles,
  };
